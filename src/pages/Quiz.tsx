    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      <div className="mb-8 animate-fade-in">
        ...
        <p className="text-ink-secondary">
          Week 1 MCQ bank with explanations — introduction, Bayesian learning and the
          naive Bayes lab. Calculation questions show full worked solutions, so keep a
          calculator handy.
        </p>
      </div>
      ...
      <div className="bg-surface border border-edge rounded-lg p-6 animate-fade-in" key={q.id + String(i)}>
        <p className="text-lg text-ink leading-relaxed mb-5 whitespace-pre-line">{q.question}</p>
        ...
        {picked !== null && (
          <div className="animate-fade-in mt-4">
            <div className="text-sm text-ink-secondary leading-relaxed bg-raised border border-edge rounded-md px-4 py-3 mb-4 whitespace-pre-line">
